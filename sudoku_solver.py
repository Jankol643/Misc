#https://github.com/kying18/sudoku
...
def find_next_empty(puzzle):
    """
    Finds the next empty space on a sudoku board (represented by -1)

    :param puzzle: soduko to find spaces in
    :type puzzle: list
    :return: row, column of next empty space on board or None, None
...
def is_valid(puzzle, guess, row, col):
    """
    Figures out whether the guess at the row and column of the puzzle is valid or not

    :param puzzle: puzzle to solve
    :type puzzle: list
    :param guess: number between 1 and 9 to check
    :type guess: int
...
def solve_sudoku(puzzle):
    ...
    :param puzzle: list of lists, each inner list is a row
    :type puzzle: list
